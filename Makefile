...
c_x64: build fibo.c
	x86_64-linux-gnu-gcc -O0 -g -o $(BUILD_DIR)/c_fibo_x64 fibo.c

c_arm64: build fibo.c
	aarch64-linux-gnu-gcc -O0 -g -o $(BUILD_DIR)/c_fibo_arm64 fibo.c
...
pancake_x64: build fibo.🥞
	...
	x86_64-linux-gnu-gcc -g -O0 -o $(BUILD_DIR)/pancake_fibo_x64 $(BUILD_DIR)/pancake_fibo_x64.S pnk_ffi.c
...
pancake_x64_ffi: build fibo.🥞
	...
	x86_64-linux-gnu-gcc -g -O0 -o $(BUILD_DIR)/pancake_fibo_x64_ffi $(BUILD_DIR)/pancake_fibo_x64_ffi.S pnk_ffi.c
...
pancake_arm64: build fibo.🥞
	...
	aarch64-linux-gnu-gcc -g -O0 -o $(BUILD_DIR)/pancake_fibo_arm64 $(BUILD_DIR)/pancake_fibo_arm64.S pnk_ffi.c
...
pancake_arm64_ffi: build fibo.🥞
	...
	aarch64-linux-gnu-gcc -g -O0 -o $(BUILD_DIR)/pancake_fibo_arm64_ffi $(BUILD_DIR)/pancake_fibo_arm64_ffi.S pnk_ffi.c
